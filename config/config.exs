  ...
  text: %{
    ...
    satiety: %{
      ...
      10 => [
        ...
        """
        <i><%= cat.name %> не притрагивается к еде и смотрит на <%= if not is_atom(who) do Member.full_name(who) else "кормушку" end %> тяжелым взглядом, полным бесконечного презрения.</i>
        """,
      ],
      vomit: """
